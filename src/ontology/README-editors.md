 ...
 * https://github.com/NFDI4Chem/VibrationSpectroscopyOntology/releases
 * https://github.com/NFDI4Chem/VibrationSpectroscopyOntology/releases/new
 ...
 * http://purl.obolibrary.org/obo/vibso/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/NFDI4Chem/VibrationSpectroscopyOntology.svg?branch=master)](https://travis-ci.org/NFDI4Chem/VibrationSpectroscopyOntology)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/NFDI4Chem](https://travis-ci.org/profile/NFDI4Chem)
 2. click the "Sync account" button
 3. Click the tick symbol next to VibrationSpectroscopyOntology
