...
in the catalog file to redirect the URL `http://purl.obolibrary.org/obo/vibso/imports/go_import.owl`
...
1. Open `src/ontology/vibso-odk.yaml`
...
1. Providing a `components/mycomp.owl:` make target in `src/ontology/vibso.Makefile`
...
1. Providing an additional attribute for the component in `src/ontology/vibso-odk.yaml`, `source`,
